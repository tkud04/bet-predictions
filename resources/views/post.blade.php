...
@section('content')
 @include('banner-2',['img' => $img,'title' => 'View Post'])
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
						...
						<h3>There is really no discipline that is more tightly intertwined</h3>
				        ...
				        <div class="leave-comments-area">
				            <form id='add-comment-form' method="{{url('add-comment')}}" method='post'>
								<fieldset>
                                    ...
                                    ?>
                                    <div class="form-group">
                                      <p class='text-danger text-bold'>You must be signed in to comment.</p>
                                    </div>
                                    <?php
                                      }
                                    ?>
                                    <div class="form-group">
                                        <?php
                                           $buttonDisabled = $user == null ? ' disabled' : '';
                                        ?>
                                        <button class="btn-send" id="add-comment-submit"{{$buttonDisabled}}>Post Comment</button>
                                    </div> 
								</fieldset>
							</form>
						</div>                                 
